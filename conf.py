...
BLOG_AUTHOR = "A.I."  # (translatable)
BLOG_TITLE = "AI Quest"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://aiquest.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://aiquest.github.io/"
BLOG_EMAIL = "ai@aiquest.io"
BLOG_DESCRIPTION = "Experiences in pursuit of AI."  # (translatable)
